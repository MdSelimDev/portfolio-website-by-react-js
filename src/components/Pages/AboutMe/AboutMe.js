            ...
            <Col lg={6} sm={12}>
              <div className="about-details">
                <p className="aboutTextPara">
                  ...
                  Express Js , MongoDB And Material Ui. Always I want to learn
                  something new for my experience increase. I am very Hard
                  Worker Person. I want growth my talent day by day.{" "}
                </p>
              </div>
